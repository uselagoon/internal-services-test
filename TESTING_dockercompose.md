...
docker compose exec -T commons sh -c "curl -kL http://go-web:3000/redis?service=valkey-8" | grep "SERVICE_HOST=valkey-8"
docker compose exec -T commons sh -c "curl -kL http://go-web:3000/redis?service=valkey-8" | grep "LAGOON_TEST_VAR=internal-services-test"
